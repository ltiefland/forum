        ...
        <Container>
            ...
            <form @submit.prevent="createPost" class="mt-6">
                ...
                <div>
                    ...
                    <TextInput id="title" class="w-full" v-model="form.title" placeholder="Give it a great title..."></TextInput>
                    <InputError :message="form.errors.title" class="mt-1"></InputError>
                </div>
                <div class="mt-3">
                    <InputLabel for="body" class="sr-only">Body</InputLabel>
                    <MarkdownEditor v-model="form.body"/>
                    <TextArea id="body" class="w-full mt-2" v-model="form.body" rows="25"></TextArea>
                    <InputError :message="form.errors.body" class="mt-1"></InputError>
                </div>
                <div class="mt-3">
